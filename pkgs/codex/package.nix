...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-R7OxEUacq6iPx/kaO0g1r94thvUn0/qzaa5mZzkL1l4=";
  };
  ...
  preBuild = ''
    if [ "''${NIX_BUILD_CORES:-1}" -gt 2 ]; then
  ...
  env = {
    ...
    # Link with lld on Darwin.
    # nixpkgs' classic open-source ld64 fails to insert
    # ARM64 branch thunks for this binary, producing
  ...
  meta = {
    ...
    mainProgram = "codex";
    maintainers = with lib.maintainers; [ delafthi jeafleohj malo ];
